...
static void doCelebrate(uint32_t t) {
  ...
  static const uint16_t cols[]={ BUDDY_CLR_YEL, BUDDY_CLR_HEART, BUDDY_CLR_CYAN, BUDDY_CLR_WHITE, BUDDY_CLR_GREEN };
  for (int i=0; i < 7; i++) {
...
static void doDizzy(uint32_t t) {
  ...
  buddyPrint("*");
  buddySetColor(BUDDY_CLR_PURPLE);
...
const buddy_species_desc_t GOOSE_SPECIES={ "goose", 0xFFFF, { doSleep, doIdle, doBusy, doAttention, doCelebrate, doDizzy, doHeart } };
