...
static void doCelebrate(uint32_t t) {
  ...
  static const uint16_t cols[]={ BUDDY_CLR_YEL, BUDDY_CLR_HEART, BUDDY_CLR_CYAN, BUDDY_CLR_WHITE, BUDDY_CLR_GREEN, BUDDY_CLR_PURPLE };
  for (int i=0; i < 7; i++) {
...
const buddy_species_desc_t CHONK_SPECIES={ "chonk", 0xFD20, { doSleep, doIdle, doBusy, doAttention, doCelebrate, doDizzy, doHeart } };
